...
i0.ɵɵngDeclareClassMetadata({
    minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: LocaleService, decorators: [{
        type: Injectable
...
class DaterangepickerComponent {
    ...
    clickApply(e) {
        ...
        if (this.chosenLabel) {
            this.choosedDate.emit({ chosenLabel: this.chosenLabel, startDate: this.startDate, endDate: this.endDate, chosenRange: this.chosenRange });
        }
    ...
    clear() {
        this.startDate = dayjs().utc(true).startOf('day');
        this.endDate = dayjs().utc(true).endOf('day');
        this.choosedDate.emit({ chosenLabel: '', startDate: null, endDate: null, chosenRange: "" });
...
i0.ɵɵngDeclareClassMetadata({
    minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: DaterangepickerComponent, decorators: [{
        type: Component,
        args: [{
            selector: 'ngx-daterangepicker-material', encapsulation: ViewEncapsulation.None, providers: [
                {
                    provide: NG_VALUE_ACCESSOR,
                    useExisting: forwardRef(() => DaterangepickerComponent),
                    multi: true
    ...
    }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: i0.ChangeDetectorRef }, { type: LocaleService }]; }, propDecorators: {
        startDate: [{
            type: Input
        }], endDate: [{
            type: Input
...
i0.ɵɵngDeclareClassMetadata({
    minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: DaterangepickerDirective, decorators: [{
        type: Directive,
        args: [{
    ...
    }], ctorParameters: function () { return [{ type: i0.ViewContainerRef }, { type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i0.KeyValueDiffers }, { type: LocaleService }, { type: i0.ElementRef }]; }, propDecorators: {
        onChange: [{
            type: Output,
            args: ['change']
        }], rangeClicked: [{
...
i0.ɵɵngDeclareClassMetadata({
    minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: NgxDaterangepickerMd, decorators: [{
        type: NgModule,
        args: [{
