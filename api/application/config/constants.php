...
// defined('LOGO_URL')      OR define('LOGO_URL', 'http://192.168.1.29/trirangainfra/api/assets/logo_main.png');
defined('LOGO_URL')      OR define('LOGO_URL', 'https://demo1.saptez.com/circuit-node/assets/images/header/logo_main.png');
defined('BASE_URL')      OR define('BASE_URL', 'http://192.168.1.6:4700/trirangainfra/');
defined('BASE_PATH')      OR define('BASE_PATH', 'http://192.168.1.6/trirangainfra/api/assets/');
...
defined('FRONT_URL')      OR define('FRONT_URL', 'http://192.168.1.6:4700/trirangainfra/');
